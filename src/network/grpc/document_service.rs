...
// `impl DocumentPort for DocumentServiceImpl` removed in ADR-015 step 2.
// The port impl now lives on the bare `DocumentService`
// (`src/storage/document/service.rs`). Consumers that hold
// `Arc<dyn DocumentPort>` get the bare service directly.
