...
mod tests {
    ...
    async fn all_openapi_spec_paths_resolve_to_a_route() {
        ...
        const SPEC_PATHS: &[(axum::http::Method, &str, bool)] = &[
            ...
            // CDC change-feed (TD-CDC).
            (
                axum::http::Method::GET,
                "/api/v2/collections/tcol/changes",
                false,
            ),
            // Time-series surface (TD-TS-1).
            (
                axum::http::Method::POST,
            ...
            (
                axum::http::Method::DELETE,
                "/api/v2/timeseries/collections/tts",
                false,
            ),
            (
                axum::http::Method::POST,
                "/api/v2/timeseries/collections/tts/ingest",
                true,
            ),
            (
                axum::http::Method::POST,
                "/api/v2/timeseries/collections/tts/query",
                true,
            ),
            (
                axum::http::Method::POST,
                "/api/v2/timeseries/collections/tts/aggregate",
                true,
            ),
            // External collections (Phase 8 F5).
            (
                axum::http::Method::POST,
                "/api/v2/external-collections",
                true,
            ),
            (
                axum::http::Method::GET,
            ...
            (
                axum::http::Method::GET,
                "/api/v2/external-collections/tec",
                false,
            ),
            (
                axum::http::Method::POST,
                "/api/v2/external-collections/tec/build",
                true,
            ),
            (
                axum::http::Method::POST,
                "/api/v2/external-collections/tec/search",
                true,
            ),
            (
                axum::http::Method::POST,
                "/api/v2/external-collections/tec/refresh",
                true,
            ),
