...
impl CompressionMetricsTracker {
    ...
    pub fn record_compression(
        ...
        let mut buffer = self.operation_buffer.entry(collection_id.to_string())
    ...
    pub fn record_decompression(
        ...
        let mut metrics = self.metrics.entry(collection_id.to_string())
...
mod tests {
    ...
    fn test_compression_recommendations() {
        ...
        let has_increase = recommendations.iter()
            .any(|r| matches!(r.recommendation_type, RecommendationType::IncreaseCompressionLevel));
        let has_decrease = recommendations.iter()
            .any(|r| matches!(r.recommendation_type, RecommendationType::DecreaseCompressionLevel));
