...
// 
//         tracing::info!(
//             "Node {} starting election, need {} votes from {} nodes",
//             node.id,
//             votes_needed,
//             cluster_size
//         );
...
//             self.should_grant_vote(&*node, candidate_id, term, last_log_index, last_log_term)
//         };
// 
//         if vote_granted {
//             tracing::info!(
...
//         } else {
//             tracing::info!(
//                 "Rejecting vote request from candidate {} for term {}",
//                 candidate_id,
//                 term
//             );
//         }
// 
//         Ok(RaftMessage::VoteResponse { term, vote_granted })
//     }
// 
...
//                 *votes_received += 1;
//                 tracing::info!(
//                     "Node {} received vote from {}, now have {}/{} votes",
//                     node_id,
//                     peer_id,
//                     *votes_received,
//                     *votes_needed
...
//             tracing::debug!(
//                 "Sending vote request from {} to {} at {}",
//                 node.id,
//                 peer_id,
//                 address
//             );
...
//         for (&peer_id, address) in peers {
//             tracing::debug!(
//                 "Sending initial heartbeat from leader {} to {} at {}",
//                 node.id,
//                 peer_id,
//                 address
//             );
...
//         Duration::from_millis((std::ptr::addr_of!(self) as usize % 150) as u64)
//     }
// }
// 
