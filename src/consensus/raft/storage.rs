...
//             ProximaDBError::Consensus(crate::core::ConsensusError::Raft(
...
//                     crate::core::ConsensusError::Raft(format!(
//                         "Non-consecutive entries: expected {}, got {}",
//                         last_stored_index + 1,
//                         first_index
//                     )),
//                 ));
...
//                     "Cannot compact to index before snapshot".to_string(),
//                 ),
//             ));
//         }
// 
...
//             StorageError::Store(raft::StorageError::Other(
//                 "Failed to acquire storage lock".into(),
//             ))
//         })?;
// 
//         Ok(RaftState {
