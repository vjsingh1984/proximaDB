...
mod tests {
    ...
    use crate::services::operations::vectors::{VectorOperationsService, OptimizedFormat, WorkloadType};
    ...
    async fn test_vector_operations_edge_cases() {
        ...
        let get_by_id_result = service.vector_by_id("test_collection", "", true, true).await;
