...
pub unsafe fn int8_squared_diff_avx2(vec_a: &[i8], vec_b: &[i8]) -> i32 {
    ...
    for i in 0..chunks {
        ...
        let diff_lo = _mm256_unpacklo_epi8(diff_vec, _mm256_cmpgt_epi8(_mm256_setzero_si256(), diff_vec));
        let diff_hi = _mm256_unpackhi_epi8(diff_vec, _mm256_cmpgt_epi8(_mm256_setzero_si256(), diff_vec));
...
mod tests {
    ...
    fn test_int8_dot_product_scalar_vs_simd() {
        ...
        let scalar_result: i32 = vec_a.iter()
            .zip(vec_b.iter())
