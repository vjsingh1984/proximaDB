...
pub fn proto_distance_to_internal(proto_value: i32) -> DistanceMetric {
    match proto_value {
        ...
        _ => {
            tracing::warn!("Unknown distance metric value: {}, defaulting to Cosine", proto_value);
...
mod tests {
    ...
    fn test_proto_to_internal_conversion() {
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::Cosine as i32), DistanceMetric::Cosine);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::Euclidean as i32), DistanceMetric::Euclidean);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::DotProduct as i32), DistanceMetric::DotProduct);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::Hamming as i32), DistanceMetric::Hamming);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::Manhattan as i32), DistanceMetric::Manhattan);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::Jaccard as i32), DistanceMetric::Jaccard);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::Chebyshev as i32), DistanceMetric::Chebyshev);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::Canberra as i32), DistanceMetric::Canberra);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::Minkowski as i32), DistanceMetric::Minkowski);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::Angular as i32), DistanceMetric::Angular);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::BrayCurtis as i32), DistanceMetric::BrayCurtis);
        assert_eq!(proto_distance_to_internal(ProtoDistanceMetric::Hellinger as i32), DistanceMetric::Hellinger);
    ...
    fn test_internal_to_proto_conversion() {
        assert_eq!(internal_distance_to_proto(DistanceMetric::Cosine), ProtoDistanceMetric::Cosine as i32);
        assert_eq!(internal_distance_to_proto(DistanceMetric::Euclidean), ProtoDistanceMetric::Euclidean as i32);
        assert_eq!(internal_distance_to_proto(DistanceMetric::DotProduct), ProtoDistanceMetric::DotProduct as i32);
    ...
    fn test_get_from_config() {
        ...
        assert_eq!(get_distance_metric_from_config(Some(&config)), DistanceMetric::Euclidean);
        
        // Test without config
        assert_eq!(get_distance_metric_from_config(None), DistanceMetric::Cosine);
    }
}