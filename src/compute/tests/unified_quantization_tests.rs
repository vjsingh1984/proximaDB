...
fn test_quantization_level_bytes() {
    ...
    let uniform4 = UnifiedQuantizationLevel {
        level_type: Some(
            crate::proto::proximadb::quantization_level::LevelType::Uniform(
                crate::proto::proximadb::UniformQuantization {
                    bits: 4,
                    scale: None,
                    offset: None,
                },
    ...
    let binary = UnifiedQuantizationLevel {
        level_type: Some(
            crate::proto::proximadb::quantization_level::LevelType::Binary(
...
fn test_quantization_level_variants() {
    ...
    if let Some(crate::proto::proximadb::quantization_level::LevelType::Scalar(scalar)) =
        &int8.level_type
    {
...
fn test_bytes_per_vector_calculation() {
    ...
    let none_level = UnifiedQuantizationLevel {
        level_type: Some(
            crate::proto::proximadb::quantization_level::LevelType::None(
    ...
    let scalar = UnifiedQuantizationLevel {
        level_type: Some(
            crate::proto::proximadb::quantization_level::LevelType::Scalar(
