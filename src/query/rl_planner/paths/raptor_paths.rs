...
pub fn paths() -> Vec<OptimizationPath> {
    vec![
        ...
        .with_use_cases(vec!["Hierarchically organized data", "Clustered workloads"]),
        ...
        .with_use_cases(vec!["Variable workloads", "When optimal mode isn't known"]),
        ...
        .with_use_cases(vec!["Large multi-tier datasets", "Cost-optimized storage"]),
    ]
}
