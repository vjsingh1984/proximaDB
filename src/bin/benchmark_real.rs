...
use proximadb::index::axis::ivf_unified::{
    CentroidConfig, IvfClusteringMethod, PostingListConfig, UnifiedIvfConfig, UnifiedIvfIndex,
};
use proximadb::index::axis::lsh_index::{AxisLshConfig, AxisLshIndex};
...
async fn benchmark_indexing() {
    ...
    for size in dataset_sizes {
        ...
        // Unified IVF benchmark
        {
            ...
            debug!(
                "  Unified IVF: build={:.2}s, QPS={:.0}, clusters={}",
