...
impl MemTableFactory {
    ...
    pub async fn create_from_config(config: &WalConfig) -> Result<Box<dyn MemTableStrategy>> {
        let memtable_type = match config.memtable.memtable_type {
            crate::storage::wal::config::MemTableType::SkipList => MemTableType::SkipList,
            crate::storage::wal::config::MemTableType::BTree => MemTableType::BTree,
            crate::storage::wal::config::MemTableType::Art => MemTableType::Art,
            crate::storage::wal::config::MemTableType::HashMap => MemTableType::HashMap,
        };
