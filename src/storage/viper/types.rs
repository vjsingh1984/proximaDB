...
pub enum SearchStrategy {
    ...
    Progressive {
        tier_result_thresholds: Vec<usize>,
    },
...
impl ViperVector {
    ...
    pub fn recommended_storage_format(&self, dimension: usize, sparsity_threshold: f32) -> VectorStorageFormat {
...
impl ClusterMetadata {
    ...
    pub fn quality_score(&self) -> f32 {
        ...
        (silhouette_normalized * 0.4 + density_score * 0.3 + stability_score * 0.3).max(0.0).min(1.0)
    }
...
impl PartitionMetadata {
    ...
    pub fn efficiency_score(&self) -> f32 {
        ...
        let size_score = 1.0 - (self.statistics.storage_size_bytes as f32 / (1024.0 * 1024.0 * 1024.0)).min(1.0); // Prefer smaller partitions
        
        (compression_score * 0.4 + access_score * 0.4 + size_score * 0.2).max(0.0).min(1.0)
    }
...
impl SearchStrategy {
    ...
    pub fn computational_cost(&self) -> f32 {
        match self {
            ...
            SearchStrategy::Adaptive { query_complexity_score, .. } => *query_complexity_score,
        }
    }
}