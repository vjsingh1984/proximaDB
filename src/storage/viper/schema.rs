...
impl ViperSchemaStrategy {
    ...
    pub(super) fn from_builder(builder: ViperSchemaBuilder, collection_config: &CollectionConfig) -> Self {
        Self {
            collection_config: collection_config.clone(),
...
impl SchemaGenerationStrategy for LegacySchemaStrategy {
    fn generate_schema(&self) -> Result<Arc<Schema>> {
        ...
        let fields = vec![
            ...
            Field::new("vectors", DataType::List(Arc::new(Field::new("item", DataType::Float32, false))), false),
