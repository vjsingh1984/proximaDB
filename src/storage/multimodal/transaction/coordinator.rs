...
pub type TransactionConfig = MultimodalTransactionConfig;
pub type TransactionStats = MultimodalTransactionStats;

/// Transaction configuration
#[derive(Debug, Clone)]
pub struct MultimodalTransactionConfig {
...
impl Default for MultimodalTransactionConfig {
    fn default() -> Self {
        Self {
...
pub struct MultimodalTransactionStats {
...
impl MultimodalTransactionCoordinator {
    ...
    pub fn new(config: MultimodalTransactionConfig) -> Self {
        Self {
            ...
            stats: RwLock::new(MultimodalTransactionStats::default()),
        }
    }
    ...
    /// Get statistics
    pub async fn stats(&self) -> MultimodalTransactionStats {
    ...
    /// Get configuration
    pub fn config(&self) -> &MultimodalTransactionConfig {
        &self.config
    }
...
mod tests {
    ...
    fn test_transaction_config_default() {
        let config = MultimodalTransactionConfig::default();
    ...
    async fn test_coordinator_distributed_detection() {
        let config = MultimodalTransactionConfig {
