...
mod tests {
    ...
    async fn test_parquet_schema_caching() {
        ...
        // Cache schema
        metadata_cache
            .cache_parquet_schema("test.parquet", schema.clone())
            .await
            .unwrap();
    ...
    async fn test_parquet_file_metadata_caching() {
        ...
        // Cache metadata
        metadata_cache
            .cache_parquet_metadata("data.parquet", file_metadata.clone())
            .await
            .unwrap();
    ...
    async fn test_row_group_metadata_caching() {
        ...
        metadata_cache
            .cache_row_group_metadata("test.parquet", 0, rg_metadata.clone())
            .await
            .unwrap();
    ...
    async fn test_batch_schema_caching() {
        ...
        // Cache batch
        metadata_cache
            .cache_parquet_schemas_batch(schemas)
            .await
            .unwrap();
    ...
    async fn test_parquet_cache_invalidation() {
        ...
        metadata_cache
            .cache_parquet_schema("temp.parquet", schema)
            .await
            .unwrap();
        ...
        metadata_cache
            .cache_parquet_metadata("temp.parquet", file_metadata)
            .await
            .unwrap();
        ...
        assert!(
            metadata_cache
                .get_parquet_schema("temp.parquet")
                .await
                .is_some()
        );
        ...
        // Invalidate
        metadata_cache
            .invalidate_parquet_file("temp.parquet")
            .await
            .unwrap();
    ...
    async fn test_cross_engine_metadata_sharing() {
        ...
        shared_cache
            .cache_parquet_schema("shared_data.parquet", viper_schema)
            .await
            .unwrap();
    ...
    async fn test_metadata_cache_memory_limits() {
        ...
        for i in 0..100 {
            ...
            let _ = small_cache
                .cache_parquet_schema(&format!("file_{}.parquet", i), schema)
                .await;
        }
        ...
        assert!(
            recent.is_some()
                || small_cache
                    .get_parquet_schema("file_0.parquet")
                    .await
                    .is_none()
        );
    }
