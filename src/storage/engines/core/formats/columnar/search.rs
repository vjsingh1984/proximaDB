...
impl FileSearcher<ParquetFile, RowGroup> for ColumnarSearcher {
    async fn search_file(
        ...
        file: &ParquetFile,
        query_vector: &[f32],
        config: &crate::storage::engines::core::ops::crate::storage::engines::core::search::search_common::SearchConfig,
    ) -> Result<Vec<SearchResult>> {
    ...
    async fn search_block(
        ...
        _block: &RowGroup,
        _query_vector: &[f32],
        _config: &crate::storage::engines::core::ops::crate::storage::engines::core::search::search_common::SearchConfig,
    ) -> Result<Vec<SearchResult>> {
