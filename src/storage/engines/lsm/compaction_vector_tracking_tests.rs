...
mod tests {
    use super::super::*;
    use crate::core::{LsmConfig, VectorRecord, VectorId};
    ...
    fn create_test_config() -> LsmConfig {
        LsmConfig {
            memtable_size_mb: 1,
            level_count: 3,
    ...
    fn create_test_lsm_record(id: &str, is_tombstone: bool, expires_at: Option<i64>) -> LsmRecord {
