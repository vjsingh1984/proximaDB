...
use crate::core::search::index_based_filter::{
    IndexBasedDataReader, MetadataSource, ReadStrategy, ColumnMetadata, ColumnDataType
};
...
impl SSTMetadataSource {
    ...
    pub async fn from_sst_file(file_path: &str) -> Result<Self> {
        ...
        let reader = crate::storage::engines::sst::readers::unified_sstable_reader::UnifiedSstableReader::new(filesystem);
    ...
    fn infer_data_type(value: &serde_json::Value) -> ColumnDataType {
        match value {
...
pub struct SSTIndexBasedReader {
    ...
    reader: crate::storage::engines::sst::readers::unified_sstable_reader::UnifiedSstableReader,
}
...
impl SSTIndexBasedReader {
    pub fn new() -> Self {
        ...
        Self {
            reader: crate::storage::engines::sst::readers::unified_sstable_reader::UnifiedSstableReader::new(filesystem),
        }
    }
    ...
    async fn read_data_by_indices(
        ...
        match read_strategy {
            ...
            ReadStrategy::SelectiveRead { indices, estimated_benefit } => {
                info!("SST: Block read with filter for {} - {} indices, {:.1}% memory savings", 
                ...
                debug!("SST: Block filtering completed - {} records", filtered_records.len());
                Ok(filtered_records)
            }
        }
    }
