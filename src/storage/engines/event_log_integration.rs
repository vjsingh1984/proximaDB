...
use crate::index::axis::eventlog::{
    EventLogService, IndexEventBuilder, StorageEngineType, IndexEvent,
};
...
impl EventLogNotifier for SstEventLogNotifier {
    ...
    fn notify_compaction(
        ...
        trace!("Notified EventLog about SST compaction for {}", collection_id);
    }
...
impl EventLogNotifier for ViperEventLogNotifier {
    ...
    fn notify_compaction(
        ...
        trace!("Notified EventLog about VIPER compaction for {}", collection_id);
    }
...
mod tests {
    use super::*;
    use crate::index::axis::eventlog::{EventLogServiceAdapter, EventLogConfig};
    ...
    async fn create_test_notifier() -> (SstEventLogNotifier, Arc<dyn EventLogService>, TempDir) {
        ...
        let event_log = EventLogServiceAdapter::embedded(
            config,
            filesystem_factory,
            collection_cache,
        ).await.unwrap();
