...
* *Proxima encoding*: Efficient compression for vector data
...
|K² Matrix
|40KB
|100 centroids, cached

|P² Matrix
|512KB
|Per rowgroup (1024 vectors)

|P×K Matrix
|100KB
|Adaptive coverage (10-100%)
...
* Vectorized Proxima encoding/decoding
...
|`boundary_ratio`
|0.8
|d_i/d_j threshold for expansion

|`spillover_threshold`
|0.15
|15% spillover trigger
|====
...
* link:../../../../../../docs/technical/storage_engine_layouts.adoc[Storage Engine Design Overview]
* link:p2_matrix_tests.rs[P² Matrix Implementation]
* link:boundary_spillover_tests.rs[Boundary Detection Algorithm]
* link:adaptive_pxk.rs[Adaptive P×K Coverage Formula]

---

_RAPTOR: Where matrices meet vectors for blazing-fast search_