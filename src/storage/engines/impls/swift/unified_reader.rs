...
impl UnifiedSwiftReader {
    ...
    pub async fn new_with_bandwidth_optimizer(
        ...
        collection_id: String,
        config: SwiftReaderConfig,
        bandwidth_optimizer: Option<Arc<crate::storage::engines::core::io::zero_copy::BandwidthOptimizer>>,
    ) -> Result<Self> {
    ...
    async fn extract_superblock_from_cache(
        &self,
        cached_metadata: Arc<Box<dyn crate::storage::engines::core::io::zero_copy::traits::EngineMetadata>>,
        superblock_id: u32,
    ) -> Result<SuperBlockMetadata> {
