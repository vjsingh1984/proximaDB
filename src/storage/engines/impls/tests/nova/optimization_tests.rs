...
//! NOVA Optimization Tests - Consolidated from tests/optimization_tests.rs
//!
//! This module contains all optimization-related tests for the NOVA engine.
//! Tests verify progressive search, zone maps, quantization optimization,
//! hierarchical statistics, streaming processing, and performance characteristics.
//!
//! Source: src/storage/engines/impls/nova/tests/optimization_tests.rs
//!
//! Test Categories:
//! - Hierarchical Statistics: Zone maps, SuperBlocks, candidate detection
//! - Streaming Processor: Memory tracking, processing stages, configuration
//! - Progressive Search: Multi-stage search, binary/INT8/PQ filtering
//! - Zone Maps: Advanced intersection, selectivity estimation
//! - Streaming Search: Cost-based ordering, execution planning, performance tracking
...
// ============================================================================
// Streaming Processor Tests (3 tests)
// ============================================================================
...
// ============================================================================
// Progressive Search Tests (5 tests)
// ============================================================================
