//! PCA Model Manager for SWIFT engine
//!
...
//!
//! ## Usage for SWIFT Engine
//!
//! SWIFT uses PCA for spatial encoding during block pruning.
//! The PCA model is:
...
pub use PCAModelManager as SwiftPCAManager;
