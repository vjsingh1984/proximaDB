...
// Manages Parquet schemas with quantization support for NOVA and VIPER
...
/// Manages schemas for columnar storage with quantization support
pub struct ColumnarSchemaManager {
...
impl Default for ColumnarSchemaManager {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    async fn test_schema_creation() {
        let manager = ColumnarSchemaManager::new();
