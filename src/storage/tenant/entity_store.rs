...
impl TenantAwareEntityStore {
    ...
    pub async fn store_entity(
        ...
        let tenant_store = self.tenant_entities
        ...
        self.entity_collection_mapping.insert(entity_key.clone(), EntityCollectionMapping {
            tenant_id: tenant_id.to_string(),
            collection_id: collection_id.to_string(),
            domain_id: None,
            created_at: Utc::now(),
        ...
        // Simple audit log
        self.audit_logger.log_entity_stored(
            tenant_id,
            collection_id,
            &entity.id,
            user_context,
        ...
        debug!("Stored entity {} in tenant {} collection {}", entity.id, tenant_id, collection_id);
        Ok(entity_key)
    }
    ...
    pub async fn get_entity(
        ...
        if entity.is_some() {
            self.audit_logger.log_entity_accessed(
                tenant_id,
                collection_id,
                entity_id,
                user_context,
    ...
    pub async fn list_entities_in_collection(
        ...
        self.audit_logger.log_collection_entities_accessed(
            tenant_id,
            collection_id,
            entities.len(),
            user_context,
    ...
    pub async fn delete_entity(
        ...
        // Log deletion
        if removed {
            self.audit_logger.log_entity_deleted(
                tenant_id,
                collection_id,
                entity_id,
                user_context,
    ...
    pub fn get_tenant_entity_stats(&self, tenant_id: &str) -> TenantEntityStats {
        let entity_count = self.tenant_entities.get(tenant_id)
            .map(|store| store.len())
            .unwrap_or(0);
        
        let header_count = self.tenant_entity_headers.get(tenant_id)
...
mod tests {
    ...
    async fn test_entity_storage_and_retrieval() {
        ...
        // Store entity
        let entity_key = entity_store.store_entity(
            "test_tenant",
            "test_collection",
            entity.clone(),
            &user_context,
    ...
    async fn test_tenant_isolation() {
        ...
        let result = entity_store.get_entity(
    ...
    async fn test_entity_deletion() {
        ...
        // Delete entity
        let deleted = entity_store.delete_entity(
            "test_tenant",
            "test_collection",
            "deletable_entity",
            &user_context,
        ...
        let retrieved_after = entity_store.get_entity(
            "test_tenant",
            "test_collection",
            "deletable_entity",
            &user_context,
    ...
    async fn test_collection_entity_listing() {
        ...
        // List entities
        let entities = entity_store.list_entities_in_collection(
            "test_tenant",
            "test_collection",
            Some(3), // Limit to 3
            &user_context,
