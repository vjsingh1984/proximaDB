...
mod tests {
    ...
    use crate::storage::persistence::write_buffer::config::{
        ...
        PerformanceConfig, WriteBufferConfig, WriteBufferStrategyType,
    };
    ...
    async fn test_performance_config_default() {
        ...
        assert_eq!(
            config.sync_mode,
            crate::storage::persistence::write_buffer::config::SyncMode::PerBatch
        );
    }

    #[tokio::test]
    async fn test_write_buffer_config_default() {
    ...
    #[tokio::test]
    async fn test_write_buffer_config_custom() {
    ...
    #[tokio::test]
    async fn test_write_buffer_config_serialization() {
        let temp_dir = TempDir::new().expect("Failed to create temp dir");
