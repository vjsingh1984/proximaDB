...
pub struct MemtableManager {
    ...
    wal_behavior: WriteBufferBehaviorWrapper,
    /// Statistics
...
impl MemtableManager {
    ...
    pub fn new(config: MemtableConfig) -> Self {
        ...
        Self {
            wal_behavior: WriteBufferBehaviorWrapper::new(config),
    ...
    pub async fn mark_batches_flushed(
        &self,
        collection_id: &str,
        batch_ids: &[crate::storage::persistence::write_buffer::BatchId],
    ) -> Result<()> {
    ...
    pub fn get_write_buffer_behavior(&self) -> &WriteBufferBehaviorWrapper {
        &self.wal_behavior
    }
}
