...
use crate::storage::persistence::wal::{
    AvroSerializationStrategy, WalBatchStrategy, WalConfig, BatchId,
};
...
fn create_test_config() -> WalConfig {
    WalConfig {
        memtable: crate::storage::persistence::wal::config::MemTableConfig {
            memtable_type: crate::storage::persistence::wal::config::MemTableType::default(),
        ...
        performance: crate::storage::persistence::wal::config::PerformanceConfig {
