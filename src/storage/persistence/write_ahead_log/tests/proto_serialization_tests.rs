...
use crate::storage::persistence::write_ahead_log::{
    ProtoSerializationStrategy, WALBatchStrategy, WALConfig, BatchId,
};
...
async fn test_proto_memory_only_mode() {
    ...
    config.performance.sync_mode = crate::storage::persistence::write_ahead_log::config::SyncMode::MemoryOnly;
