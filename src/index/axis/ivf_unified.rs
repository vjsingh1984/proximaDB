...
impl UnifiedIvfIndex {
    ...
    pub fn new_with_extraction_mode(
        ...
        let _posting_store_config = AdaptiveStoreConfig {
            ...
            backend_type: BackendType::Index {
                ...
                tier_policy: UnifiedTierPolicy {
                    ...
                    reload_strategy: crate::common::adaptive_structures::ReloadStrategy {
            ...
            V: Clone + Send + Sync + 'static,
        {
            ...
            async fn metrics(&self) -> crate::common::concurrent_structures::MetricsSnapshot {
                Default::default()
            }
            
            async fn workload_metrics(&self) -> crate::common::tier_policy_engine::WorkloadMetrics {
                Default::default()
            }
            
            async fn rebalance_tiers(&self) -> anyhow::Result<crate::common::adaptive_structures::TierRebalanceResult> {
                Ok(Default::default())
            }
        }
