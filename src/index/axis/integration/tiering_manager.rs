...
use crate::index::axis::integration::collection_state::{CollectionStateManager, CollectionTierState};
...
use crate::infrastructure::tier_policy_engine::{
    ...
    AccessPatternMetrics, WorkloadType
};
            ...
            StorageTier::CloudStandard { .. } => {
                Ok(StorageTier::CloudInfrequentAccess { 
                    provider: crate::infrastructure::tier_policy_engine::CloudProvider::AwsS3 {
                        ...
                        storage_class: crate::infrastructure::tier_policy_engine::AwsStorageClass::StandardIA,
                        lifecycle_enabled: true,
                    },
                    region: "us-east-1".to_string(),
                })
