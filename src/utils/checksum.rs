...
mod tests {
    ...
    fn test_crc32_known_vectors() {
        ...
        assert_eq!(Crc32::checksum(b"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"), 0x1FC2E6D2);
    }
    ...
    fn test_fast_crc32_consistency() {
        ...
        for &test_case in &test_cases {
            ...
            assert_eq!(regular_result, fast_result, 
                      "Results differ for test case of length {}", test_case.len());
        }
    }
    ...
    fn test_crc32_incremental_vs_oneshot() {
        ...
        let data_parts = [b"Hello", b", ", b"World", b"!", b" This", b" is", b" a", b" test."];
        
        // One-shot calculation
        let combined: Vec<u8> = data_parts.iter().flat_map(|&part| part.iter()).copied().collect();
    ...
    fn test_checksum_performance_characteristics() {
        ...
        assert!(duration.as_millis() < 100, "Checksum performance too slow: {:?}", duration);
    }
}