...
impl QueryPreprocessor {
    ...
    ) -> (Option<Arc<Vec<u8>>>, Option<Arc<Vec<i8>>>, Option<Arc<Vec<u8>>>, Option<Arc<Vec<u8>>>) {
        let mut binary = None;
        let mut int8 = None;
        let mut pq4 = None;
        let mut pq8 = None;
    ...
    fn get_quantization_levels(&self, config: &QuantizationConfig) -> Vec<UnifiedQuantizationLevel> {
...
mod tests {
    ...
    async fn test_query_preprocessing() {
        ...
        let result1 = preprocessor.preprocess(
            &query,
        ...
        let result2 = preprocessor.preprocess(
            &query,
            DistanceMetric::Cosine,
            None
        ).await;
