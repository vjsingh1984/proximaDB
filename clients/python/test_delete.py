...
create_data = {
    "operation": "create",
    "config": {"name": collection_id, "dimension": 128, "distance_metric": "cosine"},
}

print("Creating collection...")
create_response = requests.post(
    "http://localhost:5678/api/v1/collection", json=create_data
)
...
delete_response = requests.delete(
    f"http://localhost:5678/api/v1/collection/{collection_id}"
)
