...
class TestPrepareVectorRecords:
    ...
    def test_basic_conversion(self):
        ...
        records = prepare_vector_records(
            response, source_id="test_doc", source_type="test"
        )
    ...
    def test_filter_fields_handling(self):
        ...
        response = {"chunks": [{"id": "c1", "text": "Text", "embedding": [0.1]}]}
    ...
    def test_custom_metadata_function(self):
        ...
        records = prepare_vector_records(
            response, source_id="doc", chunk_metadata_fn=custom_fn
        )
    ...
    def test_preserve_embedding_metadata(self):
        ...
        # With preservation
        records = prepare_vector_records(
            response, source_id="doc", preserve_embedding_metadata=True
        )
        ...
        records = prepare_vector_records(
            response, source_id="doc", preserve_embedding_metadata=False
        )
    ...
    def test_error_handling(self):
        ...
        with pytest.raises(ValueError, match="missing embedding"):
            prepare_vector_records(
                {"chunks": [{"id": "c1", "text": "No embedding"}]}, "doc"
            )
    ...
    def test_custom_function_error_handling(self):
        ...
        records = prepare_vector_records(
            response, source_id="doc", chunk_metadata_fn=bad_fn
        )
    ...
    def test_filterable_metadata_separation(self):
        ...
        response = {
            "chunks": [
                {"id": "c1", "text": "Test content", "embedding": [0.1, 0.2, 0.3]}
            ],
            "model": "all-mpnet-base-v2",
            "chunk_size": 400,
        }
