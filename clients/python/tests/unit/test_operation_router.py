...
class TestIntelligentRouter:
    ...
    def setup_method(self):
        ...
        self.router.register_client_factory(Protocol.GRPC, lambda: self.mock_grpc_client)
        self.router.register_client_factory(Protocol.REST, lambda: self.mock_rest_client)
