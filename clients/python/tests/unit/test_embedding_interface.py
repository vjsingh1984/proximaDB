...
@pytest.mark.skip(
    reason="Integration test - requires real server. Move to tests/integration/"
)
    ...
    def test_initialization_success(self):
        ...
        try:
            ...
            if provider.is_available():
                ...
                pytest.skip(
                    "BERT provider not available - sentence-transformers not installed"
                )
        except ImportError:
...
class TestCohereEmbeddingProvider:
    ...
    def test_initialization_with_api_key(self):
        ...
        config = EmbeddingConfig(
            model_name="cohere", dimension=768, api_key="test-api-key"
        )
    ...
    def test_embed_texts_unavailable(self):
        ...
        with pytest.raises(
            RuntimeError, match="Cohere embedding provider is not available"
        ):
...
class TestEmbeddingProviderFactory:
    ...
    def test_create_provider_with_config(self):
        ...
        config = EmbeddingConfig(model_name="custom", dimension=512)
...
class TestConvenienceFunctions:
    ...
    def test_create_embedding_provider(self):
        ...
        provider = create_embedding_provider(
            provider_type="simulated", model_name="test-model", dimension=512
        )
    ...
    def test_create_embedding_provider_with_kwargs(self):
        ...
        provider = create_embedding_provider(
            provider_type="simulated", batch_size=64, normalize=False
        )
...
class TestEmbeddingProviderIntegration(BaseProximaDBTest):
    ...
    def test_semantic_chunking_with_real_embeddings(self):
        ...
        chunks = chunker.chunk_semantically(
            text=text, source_id="test_doc", base_metadata={"test": True}
        )
