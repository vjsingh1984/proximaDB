...
class TestCacheEntry:
    ...
    def test_entry_creation(self):
        ...
        entry = CacheEntry(key="test_key", value={"data": "test"}, ttl=300.0)
...
class TestResponseCache:
    ...
    def cache(self):
        ...
        return ResponseCache(backend=backend, default_ttl=300, collection_aware=True)
    ...
    def test_get_set_with_collection_tracking(self, cache):
        ...
        success = cache.set(
            "search_vectors", params, response, collection_id="test_collection"
        )
        assert success is True
...
class TestObjectPool:
    ...
    def object_pool(self):
        ...
        return ObjectPool(
            factory=factory, key_func=key_func, max_pool_size=3, enable_metrics=True
        )
...
class TestResponseCacheIntegration(BaseProximaDBTest):
    ...
    def test_cache_with_real_operations(self):
        ...
        result = cache.get(
            "search_vectors", params, fetch_func=fetch_that_shouldnt_be_called
        )
