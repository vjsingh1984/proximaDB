...
class TestFilterCondition:
    ...
    def test_filter_condition_creation(self):
        ...
        condition = FilterCondition(
            field="price", operation=FilterOp.GREATER_THAN, value=100
        )
    ...
    def test_filter_condition_to_dict(self):
        ...
        condition = FilterCondition(
            field="category", operation=FilterOp.EQUALS, value="electronics"
        )
...
class TestFilterBuilder:
    ...
    def test_to_dict_method(self):
        ...
        assert result == {
            "operator": "and",
            "conditions": [{"field": "test", "operation": "equals", "value": "value"}],
        }
...
class TestHelperFunctions:
    ...
    def test_gt_function(self):
        ...
        assert result == {
            "operator": "and",
            "conditions": [{"field": "price", "operation": "gt", "value": 100}],
        }
