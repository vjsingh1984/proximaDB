...
class TestEnhancedSemanticChunker(BaseProximaDBTest):
    ...
    def test_topic_boundary_detection_with_embeddings(self, chunker_with_embeddings):
        ...
        for boundary in boundaries:
            ...
            assert boundary.boundary_type in ["embedding_topic_change", "text_topic_change"]
    ...
    def test_semantic_coherence_with_embeddings(self, chunker_with_embeddings):
        ...
        coherent_score = chunker_with_embeddings.calculate_semantic_coherence(coherent_text)
        ...
        incoherent_score = chunker_with_embeddings.calculate_semantic_coherence(incoherent_text)
    ...
    def test_chunk_semantically_with_embeddings(self, chunker_with_embeddings):
        ...
        for chunk in chunks:
            ...
            assert chunk.metadata.get("chunk_type") in ["semantic_enhanced", "semantic_enhanced_split"]
...
class TestSemanticChunkingIntegration(BaseProximaDBTest):
    ...
    def test_semantic_chunks_to_vectors(self):
        ...
        for result in results:
            ...
            assert metadata.get("chunk_type") in ["semantic_enhanced", "semantic_enhanced_split"]
...
class TestChunkingFallback(BaseProximaDBTest):
    ...
    def test_fallback_to_basic_semantic(self):
        ...
        valid_types = {
            "semantic_basic", "semantic_enhanced", "bert_semantic_enhanced",
            "paragraph", "sliding_window", "sentence"
        }
