...
class TestUnifiedClientIntelligentSelection:
    ...
    def test_get_protocol_metrics_disabled(self, config):
        ...
        client = ProximaDBClient(config=config)  # Default: intelligent selection disabled
    ...
    def test_context_manager_with_selector(self, config):
        ...
        with patch('proximadb.unified_client.create_protocol_selector') as mock_create:
            ...
            with ProximaDBClient(config=config, enable_intelligent_selection=True) as client:
                assert client._protocol_selector is not None
    ...
    def test_traditional_auto_selection_when_disabled(self, config):
        ...
        with patch('proximadb.unified_client.ProximaDBClient._create_grpc_client') as mock_grpc:
            ...
            client = ProximaDBClient(
                config=config,
                enable_intelligent_selection=False  # Explicitly disabled
            )
