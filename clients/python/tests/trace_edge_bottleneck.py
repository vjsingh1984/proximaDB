...
try:
    ...
    print(f"  Rust create_nodes: {rust_node_time:.1f}ms ({1000*1000/rust_node_time:.0f} ops/sec)")
    ...
    for batch_size in batch_sizes:
        ...
        for i in range(batch_size):
            edges.append(proximadb.GraphEdge(
                f"n{i % 1000}",
                f"n{(i + 1) % 1000}",
        ...
        try:
            ...
            print(f"  Batch {batch_size:>5}: {elapsed:>8.1f}ms ({ops_per_sec:>8.0f} ops/sec)")
