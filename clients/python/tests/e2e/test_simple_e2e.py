...
def test_create_collection():
    ...
    assert response.status_code in [200, 201], f"Collection creation failed: {response.status_code} - {response.text}"
...
def test_list_collections():
    ...
    assert response.status_code == 200, f"Collection listing failed: {response.status_code} - {response.text}"
