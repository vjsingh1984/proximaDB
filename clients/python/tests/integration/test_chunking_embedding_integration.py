...
class TestChunkingEmbeddingIntegration:
    ...
    def test_provider_listing(self):
        ...
        for provider_name, expected_available in providers_to_test:
            try:
                ...
                print(f"{provider_name}: {'✓ Available' if is_available else '✗ Not installed'}")
    ...
    def test_metadata_handling(self):
        ...
        records = chunk_and_embed_text(
            ...
            embedding_provider=provider,
            chunking_config=ChunkingConfig(strategy=ChunkingStrategy.SLIDING_WINDOW, chunk_size=20),
