...
T = TypeVar("T", bound="GraphNodeResponse")
...
class GraphNodeResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CanonicalNode.from_dict(_data)
        ...
        graph_node_response.additional_properties = d
