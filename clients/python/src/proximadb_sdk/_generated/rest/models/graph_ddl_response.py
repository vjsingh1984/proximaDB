...
class GraphDdlResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = GraphDdlData.from_dict(_data)
        ...
        graph_ddl_response.additional_properties = d
        return graph_ddl_response
