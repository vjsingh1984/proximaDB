...
T = TypeVar("T", bound="UnifiedExecuteRequest")


@_attrs_define
class UnifiedExecuteRequest:
    """
    Attributes:
        query (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unified_execute_request.additional_properties = d
        return unified_execute_request
