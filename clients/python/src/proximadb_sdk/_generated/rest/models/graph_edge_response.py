...
T = TypeVar("T", bound="GraphEdgeResponse")
...
class GraphEdgeResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CanonicalEdge.from_dict(_data)
        ...
        graph_edge_response.additional_properties = d
        return graph_edge_response
