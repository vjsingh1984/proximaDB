...
if TYPE_CHECKING:
    ...
    from ..models.graph_traversal_data import GraphTraversalData


T = TypeVar("T", bound="GraphTraversalResponse")
...
class GraphTraversalResponse:
    ...
    Attributes:
        success (bool):
        data (GraphTraversalData | Unset):
        error (GraphErrorBody | Unset):
        metadata (GraphResponseMetadata | Unset):
    """

    success: bool
    data: GraphTraversalData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = GraphTraversalData.from_dict(_data)
        ...
        graph_traversal_response.additional_properties = d
        return graph_traversal_response
