...
) -> ErrorResponse | UpdateSchemaResponse | None:
    if response.status_code == 200:
        response_200 = UpdateSchemaResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | UpdateSchemaResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | UpdateSchemaResponse
    """
