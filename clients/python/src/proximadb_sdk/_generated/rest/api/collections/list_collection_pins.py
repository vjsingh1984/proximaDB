...
from ...models.pin_list_response import PinListResponse
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/collections/pinning",
    }
...
) -> PinListResponse | None:
    if response.status_code == 200:
        response_200 = PinListResponse.from_dict(response.json())
