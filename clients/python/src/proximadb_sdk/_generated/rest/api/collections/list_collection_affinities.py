...
from ...models.affinity_list_response import AffinityListResponse
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/collections/affinity",
    }
...
) -> AffinityListResponse | None:
    if response.status_code == 200:
        response_200 = AffinityListResponse.from_dict(response.json())
