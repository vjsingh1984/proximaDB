...
from proximadb_sdk.v2 import graph_pb2 as proximadb_dot_v2_dot_graph__pb2
...
def add_ProximaGraphServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('proximadb.v2.ProximaGraphService', rpc_method_handlers)
