...
def add_ProximaRecordServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('proximadb.v2.ProximaRecordService', rpc_method_handlers)
...
class ProximaRecordService(object):
    ...
    @staticmethod
    def BatchWriteStream(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
