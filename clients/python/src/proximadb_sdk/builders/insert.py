...
class InsertBuilder:
    ...
    def from_dataframe(self, df, id_col: str, vector_col: str, metadata_cols: Optional[List[str]] = None) -> 'InsertBuilder':
...
def batch_insert(vectors: List[VectorRecord], batch_size: int = 1000) -> tuple[List[VectorRecord], Dict[str, Any]]:
