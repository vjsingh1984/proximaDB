...
class ProximaDBClient:
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Client state
        self._client = None
        self._adapter: Optional[BaseProtocolAdapter] = None  # Primary adapter for operations
    ...
    def _create_adapter(self, protocol: str) -> BaseProtocolAdapter:
        ...
        base_url = self.config.url if hasattr(self.config, 'url') else self.config.base_url
        ...
        **kwargs
        ...
        if self._adapter:
            return self._adapter.search(
                ...
                **{k: v for k, v in kwargs.items() if k not in ('include_vectors', 'include_metadata')}
            )
