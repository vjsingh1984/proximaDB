...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in proximadb/v1/vector_pb2_grpc.py depends on'
...
def add_VectorServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('proximadb.v1.VectorService', rpc_method_handlers)
