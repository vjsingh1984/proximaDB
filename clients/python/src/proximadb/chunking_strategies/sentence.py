...
class SentenceStrategy(ChunkingStrategyInterface):
    ...
    def chunk(
        ...
        for i, sentence in enumerate(sentences):
            ...
            if current_chunk and current_length + sentence_length + 1 > self.config.chunk_size:
                ...
                if len(chunk_text) >= self.config.min_chunk_size:
                    chunk_metadata = {
                        **base_metadata,
                        ...
                        "first_sentence": current_chunk[0][:50] + "..." if len(current_chunk[0]) > 50 else current_chunk[0],
                    }
