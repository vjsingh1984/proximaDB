#!/usr/bin/env python3
"""
REST + VIPER Insert Performance Test with Persistence
...
# Test configuration
COLLECTION_NAME = "rest_viper_persist_test"
DIMENSION = 128
NUM_VECTORS = 50000
BATCH_SIZE = 1500  # Optimal for REST
...
def main():
    print("🚀 REST + VIPER Insert Performance Test")
    ...
    config = CollectionConfig(
        ...
        description="REST + VIPER persistence test"
    )
    ...
    with open("rest_viper_insert_results.json", "w") as f:
        json.dump(results, f, indent=2)
    
    print("\n📊 Results saved to rest_viper_insert_results.json")
    ...
    # Save baseline
    with open("rest_viper_baseline.json", "w") as f:
        json.dump({
