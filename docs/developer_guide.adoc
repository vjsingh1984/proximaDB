...
ProximaDB documentation uses PlantUML and Mermaid diagrams that must be converted to PNG images for rendering.
...
**Key Diagrams:**
- `proximadb-component.png` - System architecture overview
- `unified_memtable_architecture.png` - Memtable design
- `unified_quantization_system.png` - Quantization architecture
- `storage-aware-search.png` - Three-layer search flow

**Adding New Diagrams:**
1. Create source file in `docs/diagrams/plantuml/` or `docs/diagrams/`
2. Follow naming convention: `proximadb-feature-name.puml`
3. Generate PNG: `plantuml -tpng diagram.puml`
4. Reference in AsciiDoc: `image::proximadb-feature-name.png[Description]`
