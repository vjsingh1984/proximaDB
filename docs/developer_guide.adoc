...
The test suite includes comprehensive performance testing with large datasets:

[source,bash]
----
# Storage layout performance (15,000-20,000 vectors, 20MB+ data)
...
# Cross-storage search performance
pytest tests/test_storage_layouts.py::TestCrossStorageSearch -v -s
----

**Performance Characteristics:**
- Tests trigger multiple flushes and compaction operations
- Verifies search across WAL, flushed, and compacted data layers
- Measures insert rate (typically >1,758 vectors/second)
- Validates ranking consistency across storage layers
