...
[.lead]
*ProximaDB Developer Guide* provides comprehensive development documentation for the production-ready vector database built with Rust. This guide covers setup, API usage, SDK development, and contribution workflows.

[NOTE]
====
🔗 **Related Documents**: This guide connects to link:../README.adoc[Project Overview], link:hld.adoc[High-Level Design], and link:../demo/README.adoc[Demo Guide]
====
