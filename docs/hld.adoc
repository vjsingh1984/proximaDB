...
image::Unified_Architecture_Classes.png[Unified Architecture Classes,width=100%]

This class diagram illustrates the unified architecture where VectorService coordinates with SearchEngineFactory for storage-aware search, WalManager for durability, and CollectionService for metadata management.
