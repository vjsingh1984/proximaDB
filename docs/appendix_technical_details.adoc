...
image::proximadb-class-storage.png[Storage-Aware Search Architecture,width=100%]
...
image::search-optimization-flow.png[Search Optimization Flow,width=100%]
...
image::storage-tiers.png[Storage Tiers Architecture,width=100%]
...
image::wal-flush-triggers.png[WAL Flush Triggers,width=100%]
...
image::proximadb-component.png[AXIS Architecture,width=100%]
...
image::indexconfig-flow.png[Index Migration Flow,width=100%]
...
image::proximadb-component.png[Multi-Tenant Architecture,width=100%]
...
image::tenant-routing-architecture.png[Tenant Routing Architecture,width=100%]
