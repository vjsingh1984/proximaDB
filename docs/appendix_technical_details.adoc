...
[mermaid]
----
include::diagrams/compaction-triggers.mmd[]
----
...
// image::indexconfig-flow.png[Index Migration Flow,width=100%] - Mermaid diagram not available
...
// image::tenant-routing-architecture.png[Tenant Routing Architecture,width=100%] - Mermaid diagram not available
