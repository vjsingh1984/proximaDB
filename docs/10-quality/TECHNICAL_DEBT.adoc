...
| P3
| LOW
| Partial — spec + Hadoop SDK + contract gate + real handler + cursor + sync-bridge landed 2026-06-01..06-02 (`6b79cce23` + `c8050ab1a` + `63fb17e74` + `5131ec909`)
