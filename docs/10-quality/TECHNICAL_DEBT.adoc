...
| P1/P4
| MEDIUM
| *Fix landed 2026-06-16* — index-on-flush wired on the live SST path; recall-band e2e green (acceptance #1/#2/#3). Remaining: real object-store backend + post-restart reload (acceptance #4; post-restart needs AXIS rebuild-on-boot, a new feature)
