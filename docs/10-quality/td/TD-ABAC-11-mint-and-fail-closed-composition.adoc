...
* **DONE — authenticated gRPC v2 record/search live ratchet.** Credential-bound
  ...
  RPC shapes.
* **OPEN — remaining live surface row.** Add the provisioned-policy admit/deny/
  passthrough ratchet for Flight. Its carrier and seam component tests are
  pinned; they are not mislabeled as live evidence.
...
after [[TD-ABAC-10]] 10c; authenticated gRPC unary/streaming search and
point-get are also pinned. Flight stays open until it exercises live
