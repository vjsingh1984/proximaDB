...
| Priority | P1 for scale promotion. TD-RDSTRAT-8 PR-A shipped in #1128; PR-B's selective reader and evidence remain open. Neither automatic successor-layout promotion nor adaptive compaction becomes default until this collection-level envelope is measured.
