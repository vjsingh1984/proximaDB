...
* **Residual (regen item, not edited):** the *generated*
  `proximadb-proto/src/proto/proximadb.v2.rs` still carries doc comments
  saying some v2 RPCs are "gated behind `enable_grpc_v1_compat`" (2 sites).
  The flag being gone, those comments describe a nonexistent gate; they come
  from the `.proto` source and need a proto-comment edit + regen, not a
  hand-edit of generated code. Recorded here as the follow-up.
