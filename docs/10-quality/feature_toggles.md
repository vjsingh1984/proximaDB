...
the commercial-surface externalization — boundary-spec phase B4, #437; the
former `ai_endpoints` executive-dashboard/BI surface was removed by TD-OSS-2.)
...
**How to Enable**:
```bash
cargo build --features tenant_access
```
