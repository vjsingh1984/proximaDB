...
`corpus.manifest.json` with hashes, policies, contract fingerprints, histograms, corpus scope and a
zero-truncation assertion. Every stage records the SHA-256 of its tracked producer script, and
