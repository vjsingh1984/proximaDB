...
chunk fail closed. This projection makes qrels comparable across chunk sizes without pretending
that all chunks from a relevant long document are relevant passages.
