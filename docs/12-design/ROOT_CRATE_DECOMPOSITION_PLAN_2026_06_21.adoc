...
`python3 scripts/check_workspace_boundaries.py --storage-up-edges`: 271 remaining storage
up-edges (`compute` 239, `index` 12, `query` 10, `services` 10). This is now the enforced
