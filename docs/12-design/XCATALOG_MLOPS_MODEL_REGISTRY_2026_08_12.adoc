...
service, and fail-closed collection-binding resolution implemented; public REST/gRPC and MLflow
compatibility are rollout slices*. The shape is additive and legacy-read-safe.
...
. Add generated REST/gRPC lifecycle handlers and regenerate SDKs from OpenAPI/proto. Handlers lower
  to the lifecycle service and shared resolution query; no handwritten Python transport.
