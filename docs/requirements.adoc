...
image::diagrams/images/proximadb-component.png[Complete System Architecture,width=100%]
...
image::diagrams/images/WAL_Flush_Coordination_Simple.png[WAL Architecture,width=100%]
