...
Comprehensive production workflows for ProximaDB's **proto-first vector database**, delivering **6.10x search performance**, **zero double serialization**, and **unified SDK experience** for modern AI applications.
...
image::proximadb-proto-first-data-flow.png[Proto-First Collection Creation,width=100%]
