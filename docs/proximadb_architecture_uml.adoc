...
image::architecture-overview.png[Architecture Overview,width=100%]

== Core Classes Diagram (PlantUML)

image::proximadb-class-services.png[Core Classes,800,align=center]
...
image::service-architecture-classes.png[Service Architecture Classes,width=100%]
