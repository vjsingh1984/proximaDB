...
use proximadb::storage::engines::impls::sst::{CompressionAlgorithmSst};
...
async fn test_sst_compression_end_to_end() {
    ...
    let sst_storage = Arc::new(proximadb::storage::engines::impls::sst::SstStorage::new(storage_path).await.unwrap());
