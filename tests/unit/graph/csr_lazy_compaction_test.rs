...
mod embedding_mode_tests {
    ...
    #[test]
    fn test_embedding_mode_from_str() {
        // Test parsing from config strings
        assert_eq!(EmbeddingMode::from_str("none"), EmbeddingMode::None);
        assert_eq!(EmbeddingMode::from_str("None"), EmbeddingMode::None);
        assert_eq!(EmbeddingMode::from_str("NONE"), EmbeddingMode::None);
        assert_eq!(EmbeddingMode::from_str("cold"), EmbeddingMode::Cold);
        assert_eq!(EmbeddingMode::from_str("Cold"), EmbeddingMode::Cold);
        assert_eq!(EmbeddingMode::from_str("COLD"), EmbeddingMode::Cold);
        assert_eq!(EmbeddingMode::from_str("memory"), EmbeddingMode::Memory);
        assert_eq!(EmbeddingMode::from_str("Memory"), EmbeddingMode::Memory);
        assert_eq!(EmbeddingMode::from_str("MEMORY"), EmbeddingMode::Memory);

        // Invalid strings should default to None
        assert_eq!(EmbeddingMode::from_str("invalid"), EmbeddingMode::None);
        assert_eq!(EmbeddingMode::from_str(""), EmbeddingMode::None);
    }
