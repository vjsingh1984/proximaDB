...
mod vector_tests {
    ...
    async fn test_single_vector_insert() -> Result<()> {
        ...
        let vector_record =
            create_test_vector_record("test_vector_001".to_string(), collection_id.clone(), 384);
    ...
    async fn test_vector_upsert() -> Result<()> {
        ...
        let collection_id = generate_test_collection_name();
        let vector_record =
            create_test_vector_record("upsert_test_001".to_string(), collection_id.clone(), 384);
    ...
    async fn test_vector_metadata_validation() -> Result<()> {
        ...
        let collection_id = generate_test_collection_name();
        let mut vector_record =
            create_test_vector_record("metadata_test_001".to_string(), collection_id.clone(), 384);

        // Add extensive metadata
        vector_record.metadata.insert(
            "title".to_string(),
    ...
    async fn test_performance_vector_creation() -> Result<()> {
        ...
        let (vector_batch, measurement) =
            measure_performance!("Vector batch creation", batch_size, {
    ...
    async fn test_large_dimension_vectors() -> Result<()> {
        ...
        let vector_record =
            create_test_vector_record("large_dim_test".to_string(), collection_id, large_dimension);
    ...
    async fn test_vector_record_serialization() -> Result<()> {
        ...
        let collection_id = generate_test_collection_name();
        let vector_record =
            create_test_vector_record("serialization_test".to_string(), collection_id, 384);

        // Test JSON serialization
        let json_str = serde_json::to_string(&vector_record)?;
        let deserialized: proximadb::core::VectorRecord = serde_json::from_str(&json_str)?;
