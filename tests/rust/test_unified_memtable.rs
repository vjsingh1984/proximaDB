...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let value = btree.get("enable_two_stage_search")).await?;
    ...
    let value = skiplist.get("enable_two_stage_search")).await?;
    ...
    let value = wal_memtable.get("enable_two_stage_search").await?;
    ...
    let value = lsm_memtable.get("enable_two_stage_search")).await?;
