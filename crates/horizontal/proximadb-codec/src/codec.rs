...
use crate::baseline::{BaselineDecoder, BaselineEncoder};
use crate::registry::ImplementationRegistry;
use crate::types::{ProximaScheme, TypeId};
use crate::wire_format::WireFormatManager;

#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
use crate::simd::{SimdDecoder, SimdEncoder};
...
impl ProximaCodec {
    ...
    fn new() -> Self {
        ...
        #[cfg(feature = "gpu")]
        {
            use crate::impls::gpu::{GpuDecoder, GpuEncoder};
