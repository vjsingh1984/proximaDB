...
pub mod baseline {
    pub use crate::baseline::functions;
    // Re-export BaselineEncoder and BaselineDecoder at module level
    pub use crate::baseline::decoder::BaselineDecoder;
    pub use crate::baseline::encoder::BaselineEncoder;
    // Re-export encoder and decoder submodules
    pub use crate::baseline::decoder;
    pub use crate::baseline::encoder;
}
...
pub mod simd {
    ...
    pub use crate::simd::encoder;
    // Re-export decoder submodule
    pub use crate::simd::decoder;
    // Re-export at module level for convenience
    pub use crate::simd::decoder::SimdDecoder;
    pub use crate::simd::encoder::SimdEncoder;
}
