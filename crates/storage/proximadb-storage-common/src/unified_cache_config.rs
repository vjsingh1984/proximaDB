...
pub struct CacheBehaviorConfig {
    ...
    pub eviction_policy: UnifiedEvictionPolicy,
...
/// Cache eviction policy (unified variant — separate from cache_config::EvictionPolicy)
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum UnifiedEvictionPolicy {
    /// Least Recently Used
    LRU,
...
impl Default for CacheBehaviorConfig {
    fn default() -> Self {
        Self {
            ...
            eviction_policy: UnifiedEvictionPolicy::LRU,
...
impl UnifiedCacheConfig {
    ...
    pub fn high_performance() -> Self {
        Self {
            ...
            behavior: CacheBehaviorConfig {
                ...
                eviction_policy: UnifiedEvictionPolicy::ARC,
                invalidation_strategy: InvalidationStrategy::Immediate,
    ...
    pub fn cost_optimized() -> Self {
        Self {
            ...
            behavior: CacheBehaviorConfig {
                ...
                eviction_policy: UnifiedEvictionPolicy::LFU,
    ...
    pub fn write_heavy() -> Self {
        Self {
            ...
            behavior: CacheBehaviorConfig {
                default_ttl_secs: 60,
                eviction_policy: UnifiedEvictionPolicy::FIFO,
                invalidation_strategy: InvalidationStrategy::Immediate,
                warming_enabled: false,
            },
            performance: PerformanceConfig {
...
mod tests {
    ...
    fn test_config_validation() {
        ...
        bad_config.memory.data_percentage = 60;
