...
pub struct UnifiedMetricsCollector {
    ...
    current_metrics: Arc<RwLock<crate::SystemMetrics>>,
    active_alerts: Arc<RwLock<Vec<crate::Alert>>>,
    start_time: Instant,
}
...
impl UnifiedMetricsCollector {
    pub fn new() -> Self {
        Self {
            ...
            current_metrics: Arc::new(RwLock::new(crate::SystemMetrics::default())),
    ...
    pub async fn current_metrics(&self) -> crate::SystemMetrics {
        // Calculate uptime
    ...
    pub async fn metrics_summary(&self) -> MetricsSummary {
        ...
        MetricsSummary {
            ...
            critical_alerts_count: self
                ...
                .await
                .iter()
                .filter(|a| matches!(a.level, crate::schema::AlertLevel::Critical))
                .count(),
        }
    }

    /// Get active alerts (for dashboard compatibility)
    pub async fn active_alerts(&self) -> Vec<crate::Alert> {
