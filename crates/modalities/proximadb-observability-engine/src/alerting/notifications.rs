...
mod tests {
    ...
    async fn test_smtp_notification() {
        ...
        // This test sends a real email to vijay@anvaiops.com
        ...
        let email_config = EmailConfig {
            ...
            recipients: vec!["vijay@anvaiops.com".to_string()],
        };
        ...
        println!("✅ Successfully sent test email to vijay@anvaiops.com");
    }
}
