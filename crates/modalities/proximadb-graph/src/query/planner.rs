...
use proximadb_kernel::error::{QueryError, VectorDBError};
...
impl QueryPlanner {
    ...
    /// Replace graph statistics with a precomputed snapshot.
    pub fn update_statistics(&self, snapshot: &GraphStatistics) -> QueryResult<()> {
