...
fn evaluate_binary_op(
    left: &CypherValue,
    op: &super::cypher_ast::BinaryOperator,
    right: &CypherValue,
) -> Result<CypherValue> {
    use super::cypher_ast::BinaryOperator;
...
fn evaluate_unary_op(
    op: &super::cypher_ast::UnaryOperator,
    operand: &CypherValue,
) -> Result<CypherValue> {
    use super::cypher_ast::UnaryOperator;
...
fn evaluate_comparison(
    left: &CypherValue,
    op: &super::cypher_ast::CompOp,
    right: &CypherValue,
) -> Result<bool> {
    use super::cypher_ast::CompOp;
